		...
		class User
			...
			def self.load_queries
				queries={
					...
					"user_update"  => "UPDATE users SET first_name=$2, last_name=$3, email=$4, last_date=$5 WHERE id=$1",
					"user_insert_state"  => "INSERT INTO states (uid, messenger) VALUES ($1, $2) RETURNING id;",
					"user_update_state"  => "UPDATE states SET last_msg_id=$1, current=$2, expected_input=$3, expected_size=$4, buffer=$5, callback=$6, previous_screen=$7 WHERE uid=$8"
				}
